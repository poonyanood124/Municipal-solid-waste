...
plt.figtext(0.99,0.01,"Source: United Nations Environment Programme (2016)",ha="right",fontsize=10,style="italic")
plt.tight_layout()
...
plt.suptitle("Regional Waste Comparison", fontsize=16)
plt.tight_layout(rect=[0, 0, 1, 0.95])
